  ...
  return (
    <div>
      ...
      <div className="grid items-center justify-center shadow-inner shadow-yellow-500 ">
         ...
         <div className=" bg-yellow-300 h-5 sm:w-[75px] sm:top-[580px] sm:left-40 lg:top-[650px] lg:left-[160px]   lg:w-[130px]   absolute   shadow-inner rounded-md  shadow-yellow-700"/>
